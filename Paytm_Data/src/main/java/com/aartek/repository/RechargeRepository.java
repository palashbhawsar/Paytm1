...
public class RechargeRepository {
	...
	public List<Recharge> showRechargeRepo(Recharge recharge)
	{
		...
		System.out.println(recharge.getVender()+"  "+recharge.getAmount()+" "+recharge.getDate());	
		...
		for (Recharge recharge2 : recharg) {
			System.out.println(recharge2.getMobile_no()+" "+recharge2.getAmount()+" "+recharge2.getVender()+" "+recharge.getDate());
		}
		return recharg;
	}
